...
SCANNER_BUILD_VERSION = "v35-netlify-snapshots-force-start"
print(f"BOOT CHECK: {SCANNER_BUILD_VERSION} | running file: {__file__}")
print(f"BOOT CHECK: Netlify snapshots enabled={ENABLE_NETLIFY_SNAPSHOTS} | site={NETLIFY_SITE_URL} | screenshot_field={AIRTABLE_SCREENSHOT_FIELD}")
