...
SCANNER_VERSION = "v32.1"
SCANNER_NAME = "CITADEL TRADE OPPORTUNITY SCANNER v32.1 — QUALITY ENGINE CLEANUP"
...
ALERT_BRAND_NAME = "🏰 LIQUIDITY CITADEL ELITE SCANNER v32.1"
...
def build_discord_embed(coin):
    ...
    embed = {
        ...
        "footer": {
            "text": "Liquidity Citadel • v32.1 Quality Engine • Not financial advice. Confirm manually before entry."
        },
...
def print_performance_dashboard():
    ...
    print("\n" + "=" * 80)
    print("SCANNER PERFORMANCE DASHBOARD v32.1")
    print("=" * 80)
...
def send_performance_stats_discord(trigger_event="TRADE_UPDATE"):
    ...
    embed = {
        ...
        "footer": {"text": "Liquidity Citadel • v32.1 Scanner performance analytics • Not financial advice."},
        "timestamp": datetime.utcnow().isoformat(),
    }
...
def print_leaderboard_dashboard():
    ...
    print("\n" + "=" * 80)
    print(f"SCANNER LEADERBOARD v32.1 — LAST {LEADERBOARD_LOOKBACK_HOURS} HOURS")
    print("=" * 80)
...
def send_leaderboard_discord(trigger_event="TRADE CLOSED"):
    ...
    embed = {
        ...
        "footer": {"text": "Liquidity Citadel • v32.1 Scanner leaderboard • Not financial advice."},
        "timestamp": datetime.utcnow().isoformat(),
    }
...
def print_section(title, coins, sort_key, limit=10):
    ...
    for coin in coins[:limit]:
        ...
        print(f"HTF Confirmation: 1H={coin.get('structure_note_1h', 'Not checked')} | 4H={coin.get('structure_note_4h', 'Not checked')} | 1H Aligned={htf_structure_agrees(coin, '1h')} | 4H Aligned={htf_structure_agrees(coin, '4h')}")
...
def run_scanner():
    print("\n" + "=" * 190)
    print("CITADEL TRADE OPPORTUNITY SCANNER v32.1 — QUALITY ENGINE CLEANUP")
    print(f"Running file: {os.path.basename(__file__)}")
    print("Quality Engine: ACTIVE | HTF Display: ACTIVE | Discord Quality Filter: ACTIVE")
    print(f"HTF Settings: 1H={HTF_1H_BAR} | 4H={HTF_4H_BAR} | S-Tier Requires 1H={S_TIER_REQUIRES_1H} | S-Tier Requires 4H={S_TIER_REQUIRES_4H}")
    print(f"Quality Thresholds: S-Tier={S_TIER_QUALITY_THRESHOLD} | A+={A_PLUS_QUALITY_THRESHOLD} | A={A_QUALITY_THRESHOLD} | B={B_QUALITY_THRESHOLD}")
    ...
    print("Reminder: v32.1 is active — quality scoring, 1H/4H display, S-Tier filter, and stricter elite filtering.")
