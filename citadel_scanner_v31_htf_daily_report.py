...
def run_scanner():
    print("\n" + "=" * 190)
    print("CITADEL TRADE OPPORTUNITY SCANNER v31 — HTF CONFIRMATION + DAILY REPORT")
    ...
    print("Reminder: v31 adds 1H/4H confirmation, S-Tier labels, and daily scanner reports.")
